...
#- Fallback: primary @rag/llama-3.3-70b-versatile + @brag/1lama-3.1-8b-instant on
#- Cache: semantic mode (requires Portkey Enterprise - silently falls back to simp
#- Retry: 2 attempts on rate limit / server error before triggering the fallback t
